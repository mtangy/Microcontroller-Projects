...
export LoadConfig_lab5
export _LoadConfig_lab5
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab5
	lcall	LoadConfigTBL_lab5_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab5
;
;    Load configuration registers for lab5.
...
_LoadConfig_lab5:
 LoadConfig_lab5:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab5_Bank0
    mov     X, <LoadConfigTBL_lab5_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab5_Bank1
    mov     X, <LoadConfigTBL_lab5_Bank1
