...
export LoadConfigTBL_lab5_Bank1
export LoadConfigTBL_lab5_Bank0
export LoadConfigTBL_lab5_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab5_Bank0:
;  Instance name Counter24, User Module Counter24
;       Instance name Counter24, Block Name CNTR24_ISB(DBB11)
	db		37h, 00h		;Counter24_CONTROL_ISB_REG(DBB11CR0)
	db		35h, 2ch		;Counter24_PERIOD_ISB_REG(DBB11DR1)
	db		36h, 2ch		;Counter24_COMPARE_ISB_REG(DBB11DR2)
;       Instance name Counter24, Block Name CNTR24_LSB(DBB10)
	db		33h, 00h		;Counter24_CONTROL_LSB_REG(DBB10CR0)
	db		31h, 7bh		;Counter24_PERIOD_LSB_REG(DBB10DR1)
	db		32h, 7ah		;Counter24_COMPARE_LSB_REG(DBB10DR2)
;       Instance name Counter24, Block Name CNTR24_MSB(DCB12)
	db		3bh, 00h		;Counter24_CONTROL_MSB_REG(DCB12CR0)
	db		39h, 01h		;Counter24_PERIOD_MSB_REG(DCB12DR1)
	db		3ah, 01h		;Counter24_COMPARE_MSB_REG(DCB12DR2)
...
;  Global Register values Bank 0
	...
	db		b6h, 28h		; Row_0_OutputDrive_1 register (RDI0SRO1)
	...
	db		ffh
LoadConfigTBL_lab5_Bank1:
;  Instance name Counter24, User Module Counter24
;       Instance name Counter24, Block Name CNTR24_ISB(DBB11)
	db		34h, 11h		;Counter24_FUNC_ISB_REG(DBB11FN)
	db		35h, 31h		;Counter24_INPUT_ISB_REG(DBB11IN)
	db		36h, 40h		;Counter24_OUTPUT_ISB_REG(DBB11OU)
;       Instance name Counter24, Block Name CNTR24_LSB(DBB10)
	db		30h, 11h		;Counter24_FUNC_LSB_REG(DBB10FN)
	db		31h, 11h		;Counter24_INPUT_LSB_REG(DBB10IN)
	db		32h, 40h		;Counter24_OUTPUT_LSB_REG(DBB10OU)
;       Instance name Counter24, Block Name CNTR24_MSB(DCB12)
	db		38h, 31h		;Counter24_FUNC_MSB_REG(DCB12FN)
	db		39h, 31h		;Counter24_INPUT_MSB_REG(DCB12IN)
	db		3ah, 40h		;Counter24_OUTPUT_MSB_REG(DCB12OU)
;  Instance name I2CHW, User Module I2CHW
;  Instance name LCD, User Module LCD
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB03)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[02h], 80h		; Port_0_IntCtrl_0 register (PRT0IC0)
	...
	M8C_SetBank1
	mov	reg[04h], aah		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], f5h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], b5h		; Port_1_DriveMode_2 register (PRT1DM2)
