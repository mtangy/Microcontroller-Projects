...
export LoadConfig_lab2_1
export _LoadConfig_lab2_1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab2_1
	lcall	LoadConfigTBL_lab2_1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab2_1
;
;    Load configuration registers for lab2_1.
...
_LoadConfig_lab2_1:
 LoadConfig_lab2_1:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab2_1_Bank0
    mov     X, <LoadConfigTBL_lab2_1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab2_1_Bank1
    mov     X, <LoadConfigTBL_lab2_1_Bank1
