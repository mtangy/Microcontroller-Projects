...
;       Instance name DigBuf, Block Name DigBuf(DBB10)
	db		33h, 03h		;DigBuf_CONTROL_REG(DBB10CR0)
	db		31h, 00h		;DigBuf_DATA_1_REG(DBB10DR1)
	db		32h, 00h		;DigBuf_DATA_2_REG(DBB10DR2)
...
;  Instance name Counter16_1, User Module Counter16
;       Instance name Counter16_1, Block Name CNTR16_LSB(DCB02)
	db		28h, 11h		;Counter16_1_FUNC_LSB_REG(DCB02FN)
	db		29h, 15h		;Counter16_1_INPUT_LSB_REG(DCB02IN)
	db		2ah, c0h		;Counter16_1_OUTPUT_LSB_REG(DCB02OU)
;       Instance name Counter16_1, Block Name CNTR16_MSB(DCB03)
	db		2ch, 31h		;Counter16_1_FUNC_MSB_REG(DCB03FN)
	db		2dh, 35h		;Counter16_1_INPUT_MSB_REG(DCB03IN)
	db		2eh, c5h		;Counter16_1_OUTPUT_MSB_REG(DCB03OU)
;  Instance name DigBuf, User Module DigBuf
;       Instance name DigBuf, Block Name DigBuf(DBB10)
	db		30h, 22h		;DigBuf_FUNC_REG(DBB10FN)
	db		31h, e0h		;DigBuf_INPUT_REG(DBB10IN)
	db		32h, 40h		;DigBuf_OUTPUT_REG(DBB10OU)
;  Instance name LCD, User Module LCD
;  Global Register values Bank 1
	...
	db		e1h, 01h		; OscillatorControl_1 register (OSC_CR1)
