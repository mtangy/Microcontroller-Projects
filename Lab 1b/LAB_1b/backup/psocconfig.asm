...
export LoadConfig_lab_1b
export _LoadConfig_lab_1b
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab_1b
	lcall	LoadConfigTBL_lab_1b_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab_1b
;
;    Load configuration registers for lab_1b.
...
_LoadConfig_lab_1b:
 LoadConfig_lab_1b:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab_1b_Bank0
    mov     X, <LoadConfigTBL_lab_1b_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab_1b_Bank1
    mov     X, <LoadConfigTBL_lab_1b_Bank1
