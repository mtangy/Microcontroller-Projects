...
export LoadConfigTBL_lab_1b_Bank1
export LoadConfigTBL_lab_1b_Bank0
export LoadConfigTBL_lab_1b_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab_1b_Bank0:
