...
export LoadConfig_lab3_2
export _LoadConfig_lab3_2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab3_2
	lcall	LoadConfigTBL_lab3_2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab3_2
;
;    Load configuration registers for lab3_2.
...
_LoadConfig_lab3_2:
 LoadConfig_lab3_2:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab3_2_Bank0
    mov     X, <LoadConfigTBL_lab3_2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab3_2_Bank1
    mov     X, <LoadConfigTBL_lab3_2_Bank1
