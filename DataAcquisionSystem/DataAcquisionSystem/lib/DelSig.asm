...
export  DelSig_cGetDataClearFlag
export _DelSig_cGetDataClearFlag
export  DelSig_bGetDataClearFlag
export _DelSig_bGetDataClearFlag
export  DelSig_cGetData
export _DelSig_cGetData
export  DelSig_bGetData
export _DelSig_bGetData
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME:  DelSig_cGetDataClearFlag
;
...
_DelSig_cGetDataClearFlag:
 DelSig_bGetDataClearFlag:
_DelSig_bGetDataClearFlag:
...
_DelSig_bGetData:
   ; Note, data format is determined by the ISR.
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >DelSig_cResult
   mov  A, [DelSig_cResult]
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
