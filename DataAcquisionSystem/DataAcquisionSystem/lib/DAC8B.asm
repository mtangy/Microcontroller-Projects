...
export  DAC8B_Start
export _DAC8B_Start
export  DAC8B_SetPower
export _DAC8B_SetPower

export  DAC8B_WriteBlind
export _DAC8B_WriteBlind
export  DAC8B_WriteBlind2B
export _DAC8B_WriteBlind2B

export  DAC8B_WriteStall
export _DAC8B_WriteStall
export  DAC8B_WriteStall2B
export _DAC8B_WriteStall2B
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8B_Start
;  FUNCTION NAME: DAC8B_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8B_WriteBlind
;  FUNCTION NAME: DAC8B_WriteBlind2B
;
;  DESCRIPTION:
...
_DAC8B_WriteBlind:
  ...
  ENDIF
  IF DAC8B_OFFSETBINARY | DAC8B_TWOSCOMPLEMENT
    mov   X, SP
...
BlindMagSet:
    ...
    pop   X
  ENDIF
    or    A, DAC8B_CR0_HIBITS
    swap  A, X
    or    A, DAC8B_CR0_HIBITS
    mov   reg[DAC8B_MSB_CR0], A
    mov   A, X
    mov   reg[DAC8B_LSB_CR0], A
    RAM_EPILOGUE RAM_USE_CLASS_2
    ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8B_WriteStall
;  FUNCTION NAME: DAC8B_WriteStall2B
;
;  DESCRIPTION:
...
_DAC8B_Stop:
    RAM_PROLOGUE RAM_USE_CLASS_1
    and  reg[DAC8B_MSB_CR3], ~bPWRMASK
    and  reg[DAC8B_LSB_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
; End of File DAC8B.asm
