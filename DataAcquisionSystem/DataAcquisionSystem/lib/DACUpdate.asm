...
include "m8c.inc"
include "memory.inc"
include "DACUpdate.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  DACUpdate_EnableInt
export _DACUpdate_EnableInt
export  DACUpdate_DisableInt
export _DACUpdate_DisableInt
export  DACUpdate_Start
export _DACUpdate_Start
export  DACUpdate_Stop
export _DACUpdate_Stop
export  DACUpdate_WritePeriod
export _DACUpdate_WritePeriod
export  DACUpdate_WriteCompareValue
export _DACUpdate_WriteCompareValue
export  DACUpdate_bReadCompareValue
export _DACUpdate_bReadCompareValue
export  DACUpdate_bReadCounter
export _DACUpdate_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bDACUpdate_ReadCompareValue  ; deprecated
export _bDACUpdate_ReadCompareValue  ; deprecated
export  bDACUpdate_ReadCounter       ; deprecated
export _bDACUpdate_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DACUpdate_EnableInt
;
;  DESCRIPTION:
...
;
 DACUpdate_EnableInt:
_DACUpdate_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   DACUpdate_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DACUpdate_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 DACUpdate_DisableInt:
_DACUpdate_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   DACUpdate_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DACUpdate_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 DACUpdate_WritePeriod:
_DACUpdate_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[DACUpdate_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DACUpdate_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 DACUpdate_WriteCompareValue:
_DACUpdate_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[DACUpdate_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DACUpdate_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 DACUpdate_bReadCompareValue:
_DACUpdate_bReadCompareValue:
 bDACUpdate_ReadCompareValue:                    ; this name deprecated
_bDACUpdate_ReadCompareValue:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[DACUpdate_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DACUpdate_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 DACUpdate_bReadCounter:
_DACUpdate_bReadCounter:
 bDACUpdate_ReadCounter:                         ; this name deprecated
_bDACUpdate_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[DACUpdate_COMPARE_REG]           ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[DACUpdate_CONTROL_REG]           ; Save CR0 (running or stopped state)
   push  A                                       ;
   DACUpdate_Stop_M                              ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[DACUpdate_INPUT_REG]             ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[DACUpdate_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[DACUpdate_COUNTER_REG]           ; DR2 <- DR0
   mov   A, reg[DACUpdate_COMPARE_REG]           ; Stash the Count on the stack
   ...
   mov   reg[DACUpdate_INPUT_REG], A             ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[DACUpdate_CONTROL_REG], A           ;     this function was first called
