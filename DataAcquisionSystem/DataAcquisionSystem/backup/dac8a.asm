...
export  DAC8A_Start
export _DAC8A_Start
export  DAC8A_SetPower
export _DAC8A_SetPower

export  DAC8A_WriteBlind
export _DAC8A_WriteBlind
export  DAC8A_WriteBlind2B
export _DAC8A_WriteBlind2B

export  DAC8A_WriteStall
export _DAC8A_WriteStall
export  DAC8A_WriteStall2B
export _DAC8A_WriteStall2B
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8A_WriteBlind
;  FUNCTION NAME: DAC8A_WriteBlind2B
;
;  DESCRIPTION:
...
_DAC8A_WriteBlind:
  ...
  ENDIF
  IF DAC8A_OFFSETBINARY | DAC8A_TWOSCOMPLEMENT
    mov   X, SP
...
BlindMagSet:
    ...
    pop   X
  ENDIF
    or    A, DAC8A_CR0_HIBITS
    swap  A, X
    or    A, DAC8A_CR0_HIBITS
    mov   reg[DAC8A_MSB_CR0], A
    mov   A, X
    mov   reg[DAC8A_LSB_CR0], A
    RAM_EPILOGUE RAM_USE_CLASS_2
    ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8A_WriteStall
;  FUNCTION NAME: DAC8A_WriteStall2B
;
;  DESCRIPTION:
...
_DAC8A_Stop:
    RAM_PROLOGUE RAM_USE_CLASS_1
    and  reg[DAC8A_MSB_CR3], ~bPWRMASK
    and  reg[DAC8A_LSB_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
; End of File DAC8A.asm
