...
include "m8c.inc"
include "memory.inc"
include "DelSigClock.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  DelSigClock_EnableInt
export _DelSigClock_EnableInt
export  DelSigClock_DisableInt
export _DelSigClock_DisableInt
export  DelSigClock_Start
export _DelSigClock_Start
export  DelSigClock_Stop
export _DelSigClock_Stop
export  DelSigClock_WritePeriod
export _DelSigClock_WritePeriod
export  DelSigClock_WriteCompareValue
export _DelSigClock_WriteCompareValue
export  DelSigClock_bReadCompareValue
export _DelSigClock_bReadCompareValue
export  DelSigClock_bReadCounter
export _DelSigClock_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bDelSigClock_ReadCompareValue  ; deprecated
export _bDelSigClock_ReadCompareValue  ; deprecated
export  bDelSigClock_ReadCounter       ; deprecated
export _bDelSigClock_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 DelSigClock_EnableInt:
_DelSigClock_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   DelSigClock_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 DelSigClock_DisableInt:
_DelSigClock_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   DelSigClock_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_Stop
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 DelSigClock_WritePeriod:
_DelSigClock_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[DelSigClock_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 DelSigClock_WriteCompareValue:
_DelSigClock_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[DelSigClock_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 DelSigClock_bReadCompareValue:
_DelSigClock_bReadCompareValue:
 bDelSigClock_ReadCompareValue:                  ; this name deprecated
_bDelSigClock_ReadCompareValue:                  ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[DelSigClock_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DelSigClock_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 DelSigClock_bReadCounter:
_DelSigClock_bReadCounter:
 bDelSigClock_ReadCounter:                       ; this name deprecated
_bDelSigClock_ReadCounter:                       ; this name deprecated
   ...
   mov   A, reg[DelSigClock_COMPARE_REG]         ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[DelSigClock_CONTROL_REG]         ; Save CR0 (running or stopped state)
   push  A                                       ;
   DelSigClock_Stop_M                            ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[DelSigClock_INPUT_REG]           ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[DelSigClock_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[DelSigClock_COUNTER_REG]         ; DR2 <- DR0
   mov   A, reg[DelSigClock_COMPARE_REG]         ; Stash the Count on the stack
   ...
   mov   reg[DelSigClock_INPUT_REG], A           ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[DelSigClock_CONTROL_REG], A         ;     this function was first called
