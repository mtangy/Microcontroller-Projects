...
export LoadConfig_lab9_ece381
export _LoadConfig_lab9_ece381
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab9_ece381
	lcall	LoadConfigTBL_lab9_ece381_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab9_ece381
;
;    Load configuration registers for lab9_ece381.
...
;               CUR_PP
;
_LoadConfig_lab9_ece381:
 LoadConfig_lab9_ece381:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab9_ece381_Bank0
    mov     X, <LoadConfigTBL_lab9_ece381_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab9_ece381_Bank1
    mov     X, <LoadConfigTBL_lab9_ece381_Bank1
