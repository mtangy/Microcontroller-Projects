...
******************************************************************************/
#include <m8c.h>
// TempIn address and mask defines
#pragma	ioport	TempIn_Data_ADDR:	0x0
BYTE			TempIn_Data_ADDR;
#pragma	ioport	TempIn_DriveMode_0_ADDR:	0x100
BYTE			TempIn_DriveMode_0_ADDR;
#pragma	ioport	TempIn_DriveMode_1_ADDR:	0x101
BYTE			TempIn_DriveMode_1_ADDR;
#pragma	ioport	TempIn_DriveMode_2_ADDR:	0x3
BYTE			TempIn_DriveMode_2_ADDR;
#pragma	ioport	TempIn_GlobalSelect_ADDR:	0x2
BYTE			TempIn_GlobalSelect_ADDR;
#pragma	ioport	TempIn_IntCtrl_0_ADDR:	0x102
BYTE			TempIn_IntCtrl_0_ADDR;
#pragma	ioport	TempIn_IntCtrl_1_ADDR:	0x103
BYTE			TempIn_IntCtrl_1_ADDR;
#pragma	ioport	TempIn_IntEn_ADDR:	0x1
BYTE			TempIn_IntEn_ADDR;
#define TempIn_MASK 0x2
