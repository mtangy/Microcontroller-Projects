...
include "m8c.inc"
include "PWMPaino2.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWMPaino2_EnableInt
export _PWMPaino2_EnableInt
export  PWMPaino2_DisableInt
export _PWMPaino2_DisableInt
export  PWMPaino2_Start
export _PWMPaino2_Start
export  PWMPaino2_Stop
export _PWMPaino2_Stop
export  PWMPaino2_WritePeriod
export _PWMPaino2_WritePeriod
export  PWMPaino2_WritePulseWidth
export _PWMPaino2_WritePulseWidth
export  PWMPaino2_wReadPulseWidth
export _PWMPaino2_wReadPulseWidth
export  PWMPaino2_wReadCounter
export _PWMPaino2_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wPWMPaino2_ReadPulseWidth    ; deprecated
export _wPWMPaino2_ReadPulseWidth    ; deprecated
export  wPWMPaino2_ReadCounter       ; deprecated
export _wPWMPaino2_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPaino2_EnableInt
;
;  DESCRIPTION:
...
;
 PWMPaino2_EnableInt:
_PWMPaino2_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWMPaino2_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPaino2_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPaino2_DisableInt:
_PWMPaino2_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWMPaino2_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPaino2_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPaino2_WritePeriod:
_PWMPaino2_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWMPaino2_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[PWMPaino2_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPaino2_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPaino2_WritePulseWidth:
_PWMPaino2_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWMPaino2_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[PWMPaino2_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPaino2_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPaino2_wReadPulseWidth:
_PWMPaino2_wReadPulseWidth:
 wPWMPaino2_ReadPulseWidth:                      ; this name deprecated
_wPWMPaino2_ReadPulseWidth:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWMPaino2_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[PWMPaino2_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPaino2_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWMPaino2_wReadCounter:
_PWMPaino2_wReadCounter:
 wPWMPaino2_ReadCounter:                         ; this name deprecated
_wPWMPaino2_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[PWMPaino2_COMPARE_MSB_REG]       ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[PWMPaino2_COMPARE_LSB_REG]       ;
   push  A                                          ;  -stack frame now 2 bytes-
   PWMPaino2_Stop_M                              ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[PWMPaino2_INPUT_LSB_REG]         ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[PWMPaino2_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[PWMPaino2_COUNTER_MSB_REG]       ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[PWMPaino2_COMPARE_MSB_REG]       ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[PWMPaino2_COUNTER_LSB_REG]       ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[PWMPaino2_COMPARE_LSB_REG]       ; Stash the Count LSB on the stack
   ...
   mov   reg[PWMPaino2_INPUT_LSB_REG], A         ;    and restore it
   M8C_SetBank0                                     ;
   PWMPaino2_Start_M                             ; Now re-enable the PWM function
